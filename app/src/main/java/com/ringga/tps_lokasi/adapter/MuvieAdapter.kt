...
class MuvieAdapter (val context: Context): RecyclerView.Adapter<MuvieAdapter.MuvieViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MuvieAdapter.MuvieViewHolder, position: Int) {
          ...
          if(m.status == 1){
            ...
            card.setOnClickListener{
                ...
                mAlert.setPositiveButton("Tugas"){_,_->
                    ...
                    i.putExtra("longitude", m.long)
                    i.putExtra("latitude", m.lat)
